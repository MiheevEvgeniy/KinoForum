...
import com.MyProject.KinoForum.film.controller.FilmController;
...
public class FilmControllerTest {
    ...
    public void FilmController_AddFilm_ReturnCreated() throws Exception {
        ...
        response
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.directorId").value(filmDto.getDirectorId().toString()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.categoryId").value(filmDto.getCategoryId().toString()))
    ...
    public void FilmController_GetAllFilms_ReturnFilmDtoList() throws Exception{
        ...
        response
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].directorId").value(filmDto.getDirectorId().toString()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].categoryId").value(filmDto.getCategoryId().toString()))
